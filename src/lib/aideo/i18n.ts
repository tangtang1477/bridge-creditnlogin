...
export const t = {
  brand: { zh: "MovieFlow × Aideo", en: "MovieFlow × Aideo" },
  page_title: { zh: "积分互通", en: "Credits Bridge" },
  page_sub: {
    zh: "把 MovieFlow 与 Aideo 的个人积分按 1:1 互转。",
    en: "Transfer credits 1:1 between MovieFlow and your personal Aideo account.",
  },
  link_account: { zh: "关联 Aideo 账号", en: "Link Aideo Account" },
  open_aideo: { zh: "打开 Aideo", en: "Open Aideo" },
  ...
  aideo_email: { zh: "Aideo 邮箱", en: "Aideo email" },
  mf_balance: { zh: "MovieFlow 可转余额", en: "MovieFlow transferable" },
  aideo_balance: { zh: "Aideo 个人可转余额", en: "Aideo personal transferable" },
  ...
  set_aideo_password: { zh: "设置 Aideo 密码", en: "Set your Aideo password" },
  ...
  not_eligible_sub_kickoff: {
    zh: "Aideo 互通仅向 Pro 及以上方案开放，请升级套餐。",
  ...
  direction_mf_to_aideo: { zh: "MovieFlow → Aideo", en: "MovieFlow → Aideo" },
  direction_aideo_to_mf: { zh: "Aideo → MovieFlow", en: "Aideo → MovieFlow" },
